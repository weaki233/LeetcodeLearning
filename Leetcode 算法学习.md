...
<img src="./Leetcode 算法学习.assets/image-20240820110358218.png" alt="image-20240820110358218" style="zoom:67%;" />

#### 常见的操作与时间复杂度

![image-20240820110819430](./Leetcode 算法学习.assets/image-20240820110819430.png)
...
<img src="./Leetcode 算法学习.assets/image-20240820114714870.png" alt="image-20240820114714870" style="zoom: 67%;" />
...
- 应该考虑回溯或任何蛮力式的递归、暴力枚举算法
  ...
  ![image-20240820115820208](./Leetcode 算法学习.assets/image-20240820115820208.png)
...
<img src="./Leetcode 算法学习.assets/image-20240820120433253.png" alt="image-20240820120433253"  />
...
![image-20240820120624070](./Leetcode 算法学习.assets/image-20240820120624070.png)
...
1. **题干一致，设问一致**
   ...
   ![image-20240821200416766](./Leetcode 算法学习.assets/image-20240821200416766.png)

   ![image-20240821200601045](./Leetcode 算法学习.assets/image-20240821200601045.png)

2. **题干一致，设问修改**
   	![image-20240821200625760](./Leetcode 算法学习.assets/image-20240821200625760.png)

   ![image-20240821200638880](./Leetcode 算法学习.assets/image-20240821200638880.png)

3. **题干修改，设问类似**
   <img src="./Leetcode 算法学习.assets/image-20240821200918077.png" alt="image-20240821200918077" style="zoom:80%;" />

   ![image-20240821200947020](./Leetcode 算法学习.assets/image-20240821200947020.png)

4. **无类似原题，题干易懂**
   <img src="./Leetcode 算法学习.assets/image-20240821201029050.png" alt="image-20240821201029050" style="zoom:67%;" />

5. **无类似原题，题干晦涩**
   - 技巧1：如有图片示例，优先从**图片**着手进行理解
   ![image-20240821201235607](./Leetcode 算法学习.assets/image-20240821201235607.png)
   - 技巧2：排除无关信息，**抓住主干**问题![image-20240821201737300](./Leetcode 算法学习.assets/image-20240821201737300.png)
   
   - 技巧3：根据用例说明，反推题目意思
   
     ![image-20240821201806976](./Leetcode 算法学习.assets/image-20240821201806976.png)
   
7. **总结**<img src="./Leetcode 算法学习.assets/image-20240821201827080.png" alt="image-20240821201827080" style="zoom:67%;" />
